...
import { Eye, EyeOff, Mail, Lock, Globe, Share2, Gamepad2 } from 'lucide-react';
        ...
        <div className="p-8 rounded-2xl backdrop-blur-sm bg-black/50 border border-white/10">
            <div className="mb-8 text-center">
                ...
                <div className="text-white/80 flex flex-col items-center space-y-1">
                    <span className="relative group cursor-default">
                        ...
                        <span className="relative inline-block animate-pulse">AI-Powered Sales Intelligence</span>
                    </span>
                    <span className="text-xs text-white/50 animate-pulse">
                        [Press Enter to access your dashboard]
                    </span>
            ...
            <div className="mt-8">
                ...
                <div className="mt-6 grid grid-cols-3 gap-3">
                    ...
                    <SocialButton icon={<Share2 size={18} />} name="Social" />
